    ...
    <div class="col-lg-8">
        <div class="glass-card p-4" style="border-top:4px solid #e8192c">
            ...
            <table class="table mb-0">
                ...
                <tr><th style="color:#6c757d;font-weight:600;font-size:0.85rem;border-color:#f3f4f6">Journey Start</th><td style="color:#1a1a2e;border-color:#f3f4f6">{{ $booking->pickup_location ? preg_replace('/^Division\s*:\s*/i', '', $booking->pickup_location) : 'N/A' }}</td></tr>
                <tr><th style="color:#6c757d;font-weight:600;font-size:0.85rem;border-color:#f3f4f6">Journey End</th><td style="color:#1a1a2e;border-color:#f3f4f6">{{ $booking->dropoff_location ? preg_replace('/^Division\s*:\s*/i', '', $booking->dropoff_location) : 'N/A' }}</td></tr>
