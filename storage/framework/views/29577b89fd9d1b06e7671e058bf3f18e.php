    ...
    <div class="invoice-wrap">
        <div class="invoice-head">
            ...
            <div style="float:right;text-align:right">
                ...
                <div style="font-size:18px;font-weight:700">#INV-<?php echo e(str_pad((string) $booking->id, 6, '0', STR_PAD_LEFT)); ?></div>
            </div>
        ...
        <div class="invoice-body">
            <div class="mb-3">
                <span class="chip"><?php echo e(strtoupper($booking->payment_status ?? 'unpaid')); ?></span>
                <span class="muted" style="margin-left:8px">Issued <?php echo e(optional($booking->created_at)->format('d M Y, h:i A')); ?></span>
            </div>
            ...
            <div class="row mb-4">
                <div class="col-6">
                    <div class="card-lite">
                        ...
                        <div class="muted">Pickup: <?php echo e($booking->pickup_location ?? 'N/A'); ?></div>
                        <div class="muted">Dropoff: <?php echo e($booking->dropoff_location ?? 'N/A'); ?></div>
                    </div>
                </div>
                <div class="col-6" style="margin-left:3%">
                    <div class="card-lite">
                        <div class="muted">Booking Info</div>
                        <div><span class="muted">Car:</span> <span class="fw-bold"><?php echo e($booking->car_name); ?></span></div>
                        <div><span class="muted">Payment Method:</span> <?php echo e(strtoupper($booking->payment_method ?? 'N/A')); ?></div>
                        <div><span class="muted">Reference:</span> <?php echo e($booking->payment_reference ?? 'N/A'); ?></div>
                    </div>
                </div>
            </div>
            ...
            <table class="table mb-4">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-end"><?php echo e($booking->rental_days); ?></td>
                        <td class="text-end"><?php echo e($amountTk); ?></td>
                    </tr>
                </tbody>
            </table>

            <div class="summary">
                <div class="mb-2"><strong>Subtotal:</strong> <?php echo e($amountTk); ?></div>
                <div class="mb-2"><strong>VAT:</strong> 0 tk</div>
                <div class="paid">Total Paid: <?php echo e($amountTk); ?></div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\Laravel Project\car_rental_system\resources\views/bookings/invoice-download.blade.php ENDPATH**/ ?>