        ...
        <div class="row g-4">
            <div class="col-lg-7">
                <div class="glass-card p-4" style="border-top:4px solid #e8192c">
                    ...
                    <form method="POST" action="<?php echo e(route('bookings.payment.process', $booking)); ?>" id="payment-form">
                        <?php echo csrf_field(); ?>

                        <div class="mb-3">
                            <label class="form-label">Gateway Provider</label>
                            <select name="payment_provider" class="form-select <?php $__errorArgs = ['payment_provider'];
...
unset($__errorArgs, $__bag); ?>">
                                <option value="sslcommerz" <?php echo e(old('payment_provider', 'sslcommerz') === 'sslcommerz' ? 'selected' : ''); ?>>SSLCommerz (bKash / Nagad / Rocket / Card)</option>
                                <option value="bkash_pgw" <?php echo e(old('payment_provider') === 'bkash_pgw' ? 'selected' : ''); ?>>bKash PGW API</option>
                            </select>
                            ...
                            <div class="col-md-6">
                                <label class="method-box p-3 w-100" style="display:block;border:1px solid #fecdd3;border-radius:12px;background:#fff5f7;cursor:pointer">
                                    <input class="form-check-input me-2" type="radio" name="payment_method" value="bkash"
                                        <?php echo e(old('payment_method', 'bkash') === 'bkash' ? 'checked' : ''); ?>>
                            ...
                            <div class="col-md-6">
                                <label class="method-box p-3 w-100" style="display:block;border:1px solid #dcfce7;border-radius:12px;background:#f0fdf4;cursor:pointer">
                                    <input class="form-check-input me-2" type="radio" name="payment_method" value="nagad"
                                        <?php echo e(old('payment_method') === 'nagad' ? 'checked' : ''); ?>>
                            ...
                            <div class="col-md-6">
                                <label class="method-box p-3 w-100" style="display:block;border:1px solid #fde68a;border-radius:12px;background:#fffbeb;cursor:pointer">
                                    <input class="form-check-input me-2" type="radio" name="payment_method" value="rocket"
                                        <?php echo e(old('payment_method') === 'rocket' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-4 p-3" style="border-radius:10px;background:#f8fafc;border:1px solid #e2e8f0">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <strong style="font-size:1.5rem;color:#059669"><?php echo e($booking->total_amount); ?></strong>
                                </div>
            ...
            <div class="col-lg-5">
                <div class="glass-card p-4" style="border-top:4px solid #0ea5e9">
                    ...
                    <hr>
                    <div class="d-flex justify-content-between mb-2"><span>Car</span><strong><?php echo e($booking->car_name); ?></strong></div>
                    <div class="d-flex justify-content-between mb-2"><span>Pickup</span><strong><?php echo e($booking->pickup_date); ?></strong></div>
                    <div class="d-flex justify-content-between mb-2"><span>Return</span><strong><?php echo e($booking->return_date); ?></strong></div>
                    <div class="d-flex justify-content-between mb-2"><span>Status</span><strong class="text-warning"><?php echo e(ucfirst($booking->status)); ?></strong></div>
                    <div class="d-flex justify-content-between mb-0"><span>Payment</span><strong class="text-danger"><?php echo e(ucfirst($booking->payment_status ?? 'unpaid')); ?></strong></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel Project\car_rental_system\resources\views/bookings/payment.blade.php ENDPATH**/ ?>